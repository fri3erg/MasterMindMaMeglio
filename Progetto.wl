    ...
    {Cell[BoxData[{RowBox[{RowBox[{"repoURL", " ", "=", " ", 
        ...
        RowBox[{RowBox[{RowBox[{"wlFilename", " ", "=", " ", 
            ...
            ";"}], " ", RowBox[{"(*", " ", RowBox[{RowBox[{"Auto", " ", ".", 
                "wl"}], " ", "name"}], " ", "*)"}]}], "\n", 
        RowBox[{RowBox[{RowBox[{"commitMessage", " ", "=", " ", 
              "\"Rimosso codice superfluo per interfaccia di testing\""}], 
            ";"}], " ", RowBox[{"(*", RowBox[{"Cambia", " ", "qui"}], "*)"}], 
          "\n"}], "\n", RowBox[{RowBox[{RowBox[{"PacletInstall", "[", "\"C:\\\
\\Users\\\\Utente\\\\Downloads\\\\GitLink-2018.07.20.01.paclet\"", "]"}], 
            ";"}], "\n", "\n", RowBox[{"(*", " ", RowBox[{"Load", " ", 
              "GitLink"}], " ", "*)"}]}], "\n", 
     ...
     Cell[CellGroupData[
       {Cell[BoxData["\"Staging and committing changes...\""], "Print", 
         CellChangeTimes -> {{3.953006675007118*^9, 3.9530066948890038*^9}, 
           ...
           3.9533505885940094*^9}}, CellLabel -> 
          "During evaluation of In[119]:="], 
        Cell[BoxData["\"Creating clean .wl version...\""], "Print", 
         CellChangeTimes -> {{3.953006675007118*^9, 3.9530066948890038*^9}, 
           ...
           3.953047237588318*^9, {3.953047338953966*^9, 
           3.9530473688685894*^9}, {3.9533505846925335*^9, 
           3.953350588625681*^9}}, CellLabel -> 
          "During evaluation of In[119]:="]}, Open]]}, Open]]}, 
