...
(*				(*Header TODO: Scegliere se lasciarlo o meno*)
				Pane[
				  Grid[{
				    {
									          ...
									          ClickPane[
										          Framed[
										              Grid[{
										              {
										                ...
										                Style[labels["try"], Black, FontFamily -> "Consolas", FontSize -> 20, Bold]
										              }
										            },
										            Alignment -> {Center, Center}, Spacings -> {1.5, 0}
										            ],
												...
												Framed[
										              Grid[{
										              {
										                ...
										                Style[labels["try"], FontFamily -> "Consolas", FontSize -> 20,FontColor->GrayLevel[0.9], Bold]
										              }
										            },
										            Alignment -> {Center, Center}, Spacings -> {1.5, 0}
										            ],
    ...
    Dynamic[
	    If[showRules === True, 
			CreateWindow[
			  Panel[
			    Column[{
			      Style["Floating info box", 14],
			      Button["Close", showRules = False]
			    }]
			  ],
			  WindowTitle -> "Info"
			],
			ClickPane[
		        Framed[
		            Style[labels["mostraRegole"], FontSize->12, FontFamily->"Consolas"],
		            Background->LightGray,
		            FrameStyle->None,
		            RoundingRadius->10,
		            FrameMargins->{{10, 10}, {5, 5}},
